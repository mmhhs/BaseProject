...
public class PopupwindowTool {
	 ...
	 * @return
	 */
	public PopupWindow showLoadWindow(Context context,View view,String loadsString,Drawable backgroundDrawable,int animStyle,int paddingTop,int paddingBottom){
	...
	public PopupWindow getLoadWindow(Context context,String loadsString,Drawable backgroundDrawable,int animStyle,int paddingTop,int paddingBottom) {
        ...
        popupwindowContainer.setTop(paddingTop);
        popupwindowContainer.setBottom(paddingBottom);
...
//      AnimationDrawable animationDrawable = (AnimationDrawable)animation_rotate.getDrawable();
        ...
        if(backgroundDrawable!=null){
        	popupwindowLinear.setBackground(backgroundDrawable);
        }
        final PopupWindow popupWindow = new PopupWindow(view,LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT);        	
		popupWindow.setFocusable(true);		
		popupWindow.setOutsideTouchable(false);
	 ...
	 * @return
	 */
	public static PopupWindow showLoadWindow2(Context context,View view,String loadsString,Drawable backgroundDrawable,int animStyle,int paddingTop,int paddingBottom){
		PopupWindow loadPopupWindow = getLoadWindow2(context,loadsString,backgroundDrawable,animStyle,paddingTop,paddingBottom);
		loadPopupWindow.showAtLocation(view, Gravity.CENTER, 0, 0);
		return loadPopupWindow;
	}
		
	public static PopupWindow getLoadWindow2(Context context,String loadsString,Drawable backgroundDrawable,int animStyle,int paddingTop,int paddingBottom) {
		View view = LayoutInflater.from(context).inflate(R.layout.base_popupwindow_load,null, false);
	    ImageView loadImageView = (ImageView) view.findViewById(R.id.pop_load_image);
	    TextView loadText = (TextView) view.findViewById(R.id.pop_load_text);
        LinearLayout popupwindowLinear = (LinearLayout) view.findViewById(R.id.pop_load_linear);
        ...
        popupwindowLinear.setBackground(context.getResources().getDrawable(R.drawable.base_shape_corner_white));
        Animation anim = AnimationUtils.loadAnimation(context, R.anim.base_load_rotate);
//      loadImageView.setImageResource(R.anim.animation_rotate);
//      AnimationDrawable animationDrawable = (AnimationDrawable)animation_rotate.getDrawable();
        if(!loadsString.isEmpty()){
