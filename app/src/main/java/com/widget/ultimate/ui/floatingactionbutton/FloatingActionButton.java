package com.widget.ultimate.ui.floatingactionbutton;
...
public class FloatingActionButton extends ImageButton {
    ...
    void init(Context context, AttributeSet attributeSet) {
        ...
        mCircleSize = getDimension(mSize == SIZE_NORMAL ? R.dimen.base_ultimate_fab_size_normal : R.dimen.base_ultimate_fab_size_mini);
        mShadowRadius = getDimension(R.dimen.base_ultimate_fab_shadow_radius);
        mShadowOffset = getDimension(R.dimen.base_ultimate_fab_shadow_offset);
    ...
    void updateBackground() {
        ...
        float iconOffset = (mCircleSize - getDimension(R.dimen.base_ultimate_fab_icon_size)) / 2f;
    ...
    private Drawable createStrokesDrawable(RectF circleRect) {
        ...
        final float strokeWidth = getDimension(R.dimen.base_ultimate_fab_stroke_width);
